error id: file://<WORKSPACE>/src/test/scala/CORDIC/ChiselVsScalaModelTests.scala:sinhOut
file://<WORKSPACE>/src/test/scala/CORDIC/ChiselVsScalaModelTests.scala
empty definition using pc, found symbol in pc: sinhOut
...
class HyperChiselVsScalaTest extends ChiselVsScalaTester {
    ...
    if (mode == HyperCordicConstants.Mode.SinhCosh) {
        ...
        val dutSinh = dut.io.sinh@@Out.peek().litValue
