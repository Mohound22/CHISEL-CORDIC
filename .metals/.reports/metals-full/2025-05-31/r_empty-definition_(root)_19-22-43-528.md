error id: file://<WORKSPACE>/src/main/scala/CORDIC/scalaHyperModelIterable.scala:scala/collection/SeqOps#apply().
file://<WORKSPACE>/src/main/scala/CORDIC/scalaHyperModelIterable.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol scala/collection/SeqOps#apply().
...
class HyperCordicModel(width: Int, cycleCount: Int, integerBits: Int) {
  ...
  private val atanHyperLUT = getAtanHyperLUT(fractionalBits, width, cycleCount)
