error id: file://<WORKSPACE>/src/test/scala/CORDIC/scalaTestIterable.scala:CORDIC/CordicModel#
file://<WORKSPACE>/src/test/scala/CORDIC/scalaTestIterable.scala
empty definition using pc, found symbol in pc: CORDIC/CordicModel#
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -CordicModelConstants.CordicModel#
	 -CordicModel#
	 -scala/Predef.CordicModel#
offset: 459
...
class CordicModelTest extends AnyFlatSpec with Matchers {
  ...
  val model = new TrigC@@ordicModel(
    width = width,
