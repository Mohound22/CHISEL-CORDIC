error id: file://<WORKSPACE>/src/test/scala/CORDIC/scalaHyperTestIterable.scala:CORDIC/HyperCordicModel#`<init>`().(width)
file://<WORKSPACE>/src/test/scala/CORDIC/scalaHyperTestIterable.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol CORDIC/HyperCordicModel#width.
...
class HyperCordicModelTest extends AnyFlatSpec with Matchers {
  ...
  it should "produce correct magnitude in AtanhMagnitudeHyper with correction enabled" in {
    ...
    //THE ISSUE IS WITH (2.5,2.4) BOTH ANGLE AND MAGNITUDE CAUSE PROBLEMS
