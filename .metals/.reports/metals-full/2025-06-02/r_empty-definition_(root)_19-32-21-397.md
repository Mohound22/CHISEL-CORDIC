error id: file://<WORKSPACE>/src/main/scala/CORDIC/scalaLinearModelIterable.scala:CORDIC/LinearCordicModel#iter().
file://<WORKSPACE>/src/main/scala/CORDIC/scalaLinearModelIterable.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol CORDIC/LinearCordicModel#iter().
  ...
  def step(): Unit = {
    ...
    state match {
      ...
      case Done =>
        ...
        println(s"[Done] Mode: $currentMode, Product: ${fixedToDouble(productResult)}, Quotient: ${fixedToDouble(quotientResult)}")
        doneFlag = true
        state = Idle
