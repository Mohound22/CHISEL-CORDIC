error id: file://<WORKSPACE>/src/test/scala/CORDIC/CORDICTest.scala:CORDIC/trigScalaModel#iterateTowards().
file://<WORKSPACE>/src/test/scala/CORDIC/CORDICTest.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol CORDIC/trigScalaModel#iterateTowards().
...
class TrigScalaModelTestMutated extends AnyFlatSpec with Matchers {
  ...
  it should "correctly compute arctangent for positive y/x when calling iterateTowards" in {
    ...
    val x = 1.0
    val y = 1.0
    val (_, _, angle_out) = model.i@@terateTowards(0.0, x, y, true) // angle_out is totalTheta
