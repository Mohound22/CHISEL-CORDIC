error id: B149C78A6ED30E4190934A0E51F8768C
...
scala.Tuple2[Double, Double]
  ...
  last tree to typer: Template
       tree position: line 87 of file://<WORKSPACE>/src/main/scala/CORDIC/CORDICscalaModel.scala
              symbol: <none>
...
== Source file context for tree position ==
    ...
    85   }
    86 
    87   def calcSinCos(targetTheta: Double): (Double, Double){ // return (sin,cos)
    88   (sin, cos) = iterateTowards(targetTheta
    89       targetTheta: Double,
    90       inputX: Double,
...
class trigScalaModel(val cycleCount: Int) extends baseScalaModel {
  ...
  def calcSinCos(targetTheta: Double): (Double, Double){ // return (sin,cos)
  (sin, cos) = iterateTowards(targe@@tTheta
      targetTheta: Double,
      inputX: Double,
      inputY: Double,
      trueArcTanfalseSinCos: Boolean
