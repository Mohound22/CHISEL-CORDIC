error id: file://<WORKSPACE>/src/main/scala/CORDIC/CHISELtrig.scala:CORDIC/CordicSimplified#width.
file://<WORKSPACE>/src/main/scala/CORDIC/CHISELtrig.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol CORDIC/CordicSimplified#width.
...
class CordicSimplified(val width: Int, val cycleCount: Int, val integerBits: Int = 3) extends Module {
  ...
  val Y_INIT_SINCOS_fixed = 0.S(wi@@dth.W)
