error id: file://<WORKSPACE>/src/test/scala/CORDIC/CORDICTest.scala:org/scalatest/matchers/dsl/ResultOfAnTypeInvocation#should().
file://<WORKSPACE>/src/test/scala/CORDIC/CORDICTest.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol org/scalatest/matchers/dsl/ResultOfAnTypeInvocation#should().
...
class TrigScalaModelTestMutated extends AnyFlatSpec with Matchers {
  ...
  it should "throw assertion error for angles outside [-π/2, π/2] in sin/cos mode when calling iterateTowards" in {
    ...
    an [AssertionError] sho@@uld be thrownBy model.iterateTowards(math.Pi, 0.0, 0.0, false)
